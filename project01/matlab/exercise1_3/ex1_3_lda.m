...
%  Project the data onto the direction of the o ne dimensional vector v
...
[meas_recovered] = projectDataLDA(meas_norm, v);
figure(5)
hold on
plot(meas_recovered(iris_labels==0, :), meas_recovered(iris_labels==0, :),'bo', 'MarkerFaceColor', 'b');
plot(meas_recovered(iris_labels==1, :), meas_recovered(iris_labels==1, :),'rs', 'MarkerFaceColor', 'r');
plot(meas_recovered(iris_labels==2, :), meas_recovered(iris_labels==2, :),'g+', 'MarkerFaceColor', 'g');
hold off