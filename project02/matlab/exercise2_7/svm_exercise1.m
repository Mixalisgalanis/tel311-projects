...
hold on
plot(x1, x2, 'k')
plot( -- add your code here -- ,'b')  %Plot the Margin of class +1
plot( -- add your code here -- ,'r')  %Plot the Margin of class -1
hold off
...
% Find the width of the margin (lecture 7, page 21)  
width = -b / w(2);
